...
ngx_http_hello_string(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    ngx_conf_log_error(NGX_LOG_EMERG, cf, 0, "fuck hello_string:%s", local_conf->hello_string.data);
    ...
    void *conf)
{
    ...
    ngx_conf_log_error(NGX_LOG_EMERG, cf, 0, "fuck you hello_counter:%d", local_conf->hello_counter);
    return rv;
}
